...
import { JobsRender } from "../../components/jobs-render/jobs-render";

export default function Page() {
  return (
    <main className="w-full flex justify-center -mt-10 px-6 lg:px-16 z-10">
      <div className="w-full lg:max-w-w-content-lg flex flex-col gap-y-12">
